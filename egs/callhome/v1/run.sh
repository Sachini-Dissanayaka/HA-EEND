...
exp_dir=exp/diarize/model
conf_dir=conf

train_dir=~/HA-EEND/egs/librispeech/v1/data/simu/data/train_clean_100_ns2_beta2_2000
dev_dir=~/HA-EEND/egs/librispeech/v1/data/simu/data/dev_clean_100_ns2_beta2_500
model_dir=$exp_dir
train_conf=$conf_dir/train.yaml

train_adapt_dir=$PWD/data/eval/callhome1_spk2
dev_adapt_dir=$PWD/data/eval/callhome2_spk2
...
test_dir=$PWD/data/eval/callhome2_spk2
...
if [ $stage -le 4 ]; then
    ...
    python ~/HA-EEND/eend/bin/model_averaging.py $test_model $ifiles
fi
