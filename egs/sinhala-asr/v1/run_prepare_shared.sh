...
sinhala_asr_dir=/home/yoshani/HA-EEND/egs/sinhala-asr/v1/data/local/sinhala_asr_data
...
#     fi
    ...
    if ! validate_data_dir.sh --no-text $sad_work_dir/sinhala_asr_seg; then
    ...
    if ! validate_data_dir.sh --no-text --no-feats data/sinhala_asr_cv; then
        copy_data_dir.sh sinhala_asr_dir data/sinhala_asr_seg
        awk '$4-$3>1.5{print;}' $sad_work_dir/sinhala_asr_seg/segments > data/sinhala_asr_seg/segments
        cp $sad_work_dir/sinhala_asr_seg/{utt2spk,spk2utt} data/sinhala_asr_seg
        fix_data_dir.sh data/sinhala_asr_seg
        utils/subset_data_dir_tr_cv.sh data/sinhala_asr_seg data/sinhala_asr_tr data/sinhala_asr_cv
    fi
fi
