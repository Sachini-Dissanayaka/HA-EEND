...
local/kaldi_converter_1.py -d $CORPUSDIR -f $full_file --utt2spk    | sort -k1,1 > data/sinhala_asr_train/utt2spk
local/kaldi_converter_1.py -d $CORPUSDIR -f $full_file --wavscp     | sort -k1,1 > data/sinhala_asr_train/wav.scp
