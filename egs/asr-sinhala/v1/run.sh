...
test_dir_ch=data/callsinhala2
test_dir=data/simu/data/sinhala_asr_test_ns2_beta2_500
train_conf=$conf_dir/train.yaml

train_adapt_dir=data/callsinhala1
dev_adapt_dir=data/callsinhala2
