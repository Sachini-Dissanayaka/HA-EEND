...
from modules.py import ScaledDotProductAttention, DenseAttention, RandomAttention
...
class SynthesizerAttention(nn.Module):
    ...
    def __init__(self, max_seq_len, batch_size, n_head, d_model, attn_type, dropout=0.1):
        super().__init__()
